...
String contact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descp=findViewById(R.id.desc_report);
        rpno=findViewById(R.id.number_ca);
        photo=findViewById(R.id.photo_report);
        db= FirebaseDatabase.getInstance().getReference("Reports").child(email).child("Criminal Activity");
...
public void addData(){ String x=getPath(uri_global);
    String desc1=descp.getText().toString();
    String rpno1=rpno.getText().toString();
    a.add(desc1);
    a.add(x);
    suspiciousobject_details ca=new suspiciousobject_details(a);
    db.child(rpno1).setValue(ca);
}
    @Override
